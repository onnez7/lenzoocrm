...
export const getFranchiseById = async (req: Request, res: Response): Promise<void> => {
...
// Criar nova franquia
export const createFranchise = async (req: Request, res: Response): Promise<void> => {
...
// Atualizar franquia
export const updateFranchise = async (req: Request, res: Response): Promise<void> => {
  const franchiseId = parseInt(req.params.id);
...
// Deletar franquia
export const deleteFranchise = async (req: Request, res: Response): Promise<void> => {
  const franchiseId = parseInt(req.params.id);
