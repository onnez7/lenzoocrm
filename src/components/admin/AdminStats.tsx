...
export function AdminStats() {
  ...
  const statsData = [
    ...
    },
    {
      ...
      icon: AlertTriangle,
      color: stats.pendingReceivables > 0 || stats.pendingPayables > 0 ? "text-destructive" : "text-success",
      bgColor: stats.pendingReceivables > 0 || stats.pendingPayables > 0 ? "bg-red-100" : "bg-success/10",
