...
const TriggerNode = ({ data }: { data: any }) => (
  <div className="px-4 py-2 shadow-md rounded-md bg-success/10 border-2 border-green-300">
    <div className="flex items-center">
      <div className="ml-2">
        <div className="text-lg font-bold text-success">{data.label}</div>
        <div className="text-success text-sm">{data.description}</div>
      </div>
    </div>
  </div>
);
