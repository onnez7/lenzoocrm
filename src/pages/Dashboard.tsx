...
const categoryData = [
  { name: "Óculos de Grau", value: 45, fill: "hsl(var(--chart-1))" },
  { name: "Óculos de Sol", value: 30, fill: "hsl(var(--chart-2))" },
  { name: "Lentes de Contato", value: 15, fill: "hsl(var(--chart-3))" },
  { name: "Acessórios", value: 10, fill: "hsl(var(--chart-4))" },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-success">+8</span> novos este mês
            </p>
          </CardContent>
        </Card>
