    ...
    switch (type) {
      ...
      case "adjustment":
        return {
          ...
          icon: RotateCcw,
          color: quantity > 0 ? "text-success" : "text-destructive",
          sign: quantity > 0 ? "+" : ""
        };
      case "transfer":
        return {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-success">{entriesCount}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-destructive">{exitsCount}</div>
