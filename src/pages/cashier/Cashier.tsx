        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="flex items-center space-x-2">
              <DollarSign className={`h-5 w-5 ${currentSession ? 'text-success' : 'text-destructive'}`} />
              <span>Status do Caixa</span>
            </CardTitle>
            <Badge variant={currentSession ? "default" : "secondary"} 
                   className={currentSession ? "bg-success/10 text-success" : "bg-red-100 text-red-800"}>
                      ...
                      <TableRow key={order.id}>
                        ...
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            ...
                            {order.status === 'completed' && <CheckCircle className="h-4 w-4 text-success" />}
