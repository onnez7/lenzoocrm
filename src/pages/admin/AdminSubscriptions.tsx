...
export default function AdminSubscriptions() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'past_due':
        return <Badge className="bg-warning/10 text-warning">Vencida</Badge>;
      case 'canceled':
      ...
      {metrics && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-success">{metrics.active_subscriptions}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-destructive">{metrics.canceled_subscriptions}</div>
              ...
              <Card key={plan.id} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className={plan.is_active ? "bg-success/10 text-success" : "bg-secondary text-secondary-foreground"}>
