                ...
                <div className="space-y-3">
                  {recentRefunds.map((refund, index) => (
                    <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                      ...
                      <div className="text-right">
                        <div className="font-bold text-destructive">-R$ {refund.amount.toFixed(2)}</div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="text-center p-4 border rounded-lg">
                  <div className="text-2xl font-bold text-success">R$ 4.798,80</div>
                ...
                <div className="text-center p-4 border rounded-lg">
                  <div className="text-2xl font-bold text-destructive">R$ 199,90</div>
